...
Binary nanopore masks

Overlay images showing predicted pore locations

nanopore_analyzer.py
Performs post-detection analysis:

Calculates aspect ratio, area, and equivalent pore diameter

Computes porosity (%) and pore count

Classifies pores as circular or elongated

Generates histograms and overlay plots
